...
string GenericRubikCube::getCornerColorString(uint8_t ind) const {
    string str = "";
...
uint8_t GenericRubikCube::getCornerIndex(uint8_t ind) const {
...
uint8_t GenericRubikCube::getCornerOrientation(uint8_t ind) const {
    string corner = getCornerColorString(ind);
