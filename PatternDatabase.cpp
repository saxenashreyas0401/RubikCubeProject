...
bool PatternDatabase::setNumMoves(const GenericRubikCube &cube, const uint8_t numMoves) {
...
uint8_t PatternDatabase::getNumMoves(const GenericRubikCube &cube) const {
